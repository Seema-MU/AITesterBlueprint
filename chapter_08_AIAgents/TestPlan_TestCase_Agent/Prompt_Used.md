Use only the folder @file:chapter_08_AIAgents/TestPlan_TestCase_Agent 

Let's use the BLAST.md file, and let's go with protocol 0, which is the first step. Our main objective is to create a test plan and automation test cases for regression creator from a Jira ID.
